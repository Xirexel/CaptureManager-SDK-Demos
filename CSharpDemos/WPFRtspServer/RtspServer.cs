...
public class RtspServer : IDisposable
{
    ...
    List<Tuple<RtspServer.StreamType, int, string>> mStreams;
    ...
    public RtspServer(List<Tuple<RtspServer.StreamType, int, string>> aStreams, int portNumber, String username, String password)
    {
