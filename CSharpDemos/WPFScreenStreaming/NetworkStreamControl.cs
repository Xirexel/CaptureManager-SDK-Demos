...
{
    delegate void StartSession();
    delegate void WriteClientIP(string aIPstring);

    class NetworkStreamControl
    {
        ...
        class HttpOutputByteStream : IMFByteStream
        {
            ...
            class WebServer
            {
                ...
                TcpClient mClientBag = null;
                event StartSession mStartSession = null;
                event StartSession mStopSession = null;
                event WriteClientIP mWriteClientIP = null;
                ...
                public void Stop()
                {
                    try
                    {
                        ...
                        if(mClientBag != null)
                        {
                            mClientBag.Client.Close();

                            mClientBag.Client.Dispose();
                        ...
                        else
                        {
                            ...
                            if (socket.Connected)
                            {
                                ...
                                lock (this)
                                {
                                    ...
                                    if (mStartSession != null)
                                        mStartSession();

                                    if (mWriteClientIP != null)
                                        mWriteClientIP(socket.LocalEndPoint.ToString());
                                }
                            }
                        }
                    }
                ...
                public void sendRawData(IntPtr pb, int cb)
                {
                    do
                    {
                        ...
                        {
                            if (!SendToClient(lTempMemory, cb, mClientBag))
                            {
                                ...
                                if (mClientBag != null)
                                {
                                    ...
                                    ThreadPool.QueueUserWorkItem(new WaitCallback((x) => this.mStopSession()));
                                }
        ...
        HttpOutputByteStream mServer = null;
