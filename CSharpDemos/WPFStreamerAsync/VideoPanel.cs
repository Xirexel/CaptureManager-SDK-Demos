...
namespace WPFStreamerAsync
{
    public class VideoPanel : System.Windows.Controls.ContentControl
    {
        ...
        private class D3D9Image : D3DImage
        {
            ...
            private bool init()
            {
                ...
                do
                {
                    ...
                    using (var device = CreateDevice(WPFStreamer.Interop.NativeMethods.GetDesktopWindow()))
                    {
            ...
            private static WPFStreamer.Interop.Direct3DDevice9Ex CreateDevice(IntPtr handle)
            {
        ...
        private Direct3DSurface9 sharedResource = null;

        internal Direct3DSurface9 SharedResource { get { return sharedResource; } }
