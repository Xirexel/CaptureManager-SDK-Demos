...
namespace VirtualCameraDShowFilter
{
    ...
    [ComVisible(true)]
    [Guid("1229E07E-AFA8-4A55-8651-479830110A9F")]
    ...
    public class VirtualCamFilter : BaseSourceFilter, IAMFilterMiscFlags
    {
        ...
        private int c_iDefaultWidth = (int)CapturePipeline.Instance.VideoWidth;
        private int c_iDefaultHeight = (int)CapturePipeline.Instance.VideoHeight;
        ...
        private int c_nMinWidth = (int)CapturePipeline.Instance.VideoWidth;
        private int c_nMinHeight = (int)CapturePipeline.Instance.VideoHeight;
        private int c_nMaxWidth = (int)CapturePipeline.Instance.VideoWidth;
        private int c_nMaxHeight = (int)CapturePipeline.Instance.VideoHeight;
        ...
        protected int m_nWidth = (int)CapturePipeline.Instance.VideoWidth;
        protected int m_nHeight = (int)CapturePipeline.Instance.VideoHeight;
        ...
        public override int Pause()
        {
            if (m_State == FilterState.Stopped)
            {
                ...
                m_nMaxWidth = (int)CapturePipeline.Instance.VideoWidth; // HORZRES
                m_nMaxHeight = (int)CapturePipeline.Instance.VideoHeight; // VERTRES
